...
const GenerateDocument: React.FC = () => {
  ...
  const handleSend = () => {
    router.push('/generate-document-step_1');
  };
    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <main className="py-10 flex-1 flex flex-col justify-center items-center p-4">
        ...
        <div className="flex flex-col justify-center flex-grow w-full max-w-7xl mb-10">
          <h1 className="text-4xl font-bold mb-8">Número do processo</h1>
          <div className="flex space-x-2 mb-8">
            <span className="text-yellow-500">Etapa 1</span>
            <span>&gt;</span>
            <span>Etapa 2</span>
            <span>&gt;</span>
            <span>Final</span>
          </div>
          <p className="text-lg text-gray-600 mb-4">Informe o número do processo.</p>
          <input 
            type="text" 
